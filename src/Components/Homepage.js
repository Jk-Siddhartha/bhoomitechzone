      ...
      <div className="homepage-intro">
        ...
        >
          ...
          <div className="carousel-slide">
            ...
            <div className="overlay">
              <h2>
                Bhoomi Techzone: Your Gateway to Exceptional Tech Services and
                Industry Expertise.
              </h2>
              <p>
                At Bhoomi Techzone, we pride ourselves on delivering the
                best-in-class tech services and unwavering customer support to
                help you excel in your industry. With our industry-leading
          ...
          <div className="carousel-slide">
            ...
            <div className="overlay">
              <h2>
                Bhoomi Techzone: Delivering Top-notch Tech Services and Expert
                Support
              </h2>
              <p>
